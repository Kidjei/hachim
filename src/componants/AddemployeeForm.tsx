...
export default function AddemployeeForm(props: Props) {
  ...
  return (
    <form onSubmit={onSubmitBtnClickHnd}>
      <Box
        sx={{width: "1192px",display: "flex",flexDirection: "column",justifyContent: "space-evenly",alignItems: "center",margin: "0 auto",marginTop: "20px",backgroundColor: "#F5F7F9",height: "442px",}} >
        ...
        <Box sx={{display: "flex",flexDirection: "row",width: "160%",justifyContent: "space-around"}}>
          <Button variant="contained" onClick={onBackBtnClickHnd}  color="success"> BackBtnClick</Button>
          <Button variant="contained" onClick={onSubmitBtnClickHnd}>SubmitBtnClick</Button>
        </Box>
